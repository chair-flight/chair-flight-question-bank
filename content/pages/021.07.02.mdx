...
<Question
  id="WNR5OTGE1K"
  lo="021.07.02.01.01"
  contentRef="#smiths-ice-detector"
>
  ...
  <Option correct>Decrease in dynamic pressure</Option>
  <Option>Increase in dynamic pressure</Option>
</Question>

<Question id="305R40DDBT" lo="021.07.02.01.01">
  <Text variant="oneCorrect">
...
<Option subject={[["Rosemount ice detector"]]}>
  A vibrating rod is placed onto the incoming airflow. When icing conditions are
  observed the vibration frequency is reduced resulting in an alarm light in the
  cockpit
</Option>

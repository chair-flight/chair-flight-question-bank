...
<Question id="ZRON7SV6I1" lo={["021.01.01.01.01"]}>
...
<Option correct>Fail Safe implies multiple load Paths</Option>
...
<Question id="DD5Q0CX1SK" lo={["021.01.01.01.01", "021.01.01.01.02"]}>
  <Text variant="oneCorrect">
...
<Option subject={[["a fail-safe designed structure"]]}>
...
<Option subject={[["a Safe-life structure"]]}>
...
<Option why="This is a mix of the definition of a safe-life and a fail-safe structure">
  Multiple load paths through a structure that is replaced after limited usage
</Option>

{" "}

<Option why="Different components have different design safety factors.">
  A single load path can withstand 1.5 times the maximum design load
</Option>

  <Option why="A fail-safe structure does not necessarily have only one load path with all other being redundant">

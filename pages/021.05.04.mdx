...
<Option>ACEs convert digital signals into hydraulic actuator movements</Option>
...
<Option>
  Reduction of electric and hydraulic power required to operate control surfaces
</Option>
...
<Option correct>
  The link between the pilot inputs and control surfaces is done indirectly via
  a computer
</Option>
<Option>

...
<Question id="VN4NNHQZ8P" lo="021.07.01.01.04">
  <Text variant="oneCorrect">
    The <Subject /> anti-ice system...
  </Text>

{" "}

<Option subject={[["wing"], ["in-flight"]]}>
  The leading edge or the slats, either partially or completely
</Option>

{" "}

<Option subject={[["in-flight"]]}>
  prevents ice formation on the engine air intakes.
</Option>

{" "}

<Option>protects the whole leading edge except for the slats</Option>

{" "}

<Option>
  protects the whole leading edge and the whole under wing surface
</Option>

  <Option>protects the whole upper wing surface and the flaps</Option>
  <Option>prevents ice formation on the trailing edge flaps.</Option>
  <Option>removes ice formed on the leading edge flaps.</Option>
  <Option>removes ice formed on the tail surfaces.</Option>
</Question>

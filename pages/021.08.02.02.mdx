...
1.  **021.08.02.02.01** -- Explain the function of the fuel system:
    - lines;
...
3.  **021.08.02.02.03** -- Interpret a typical fuel system schematic to the
...
<Question id="DKVGIVFZBT" lo="021.08.02.02.01" contentRef="### Baffles and Baffle valves">
  <Text variant="oneCorrect">
    The purpose of <Subject /> in wing fuel tanks is to...
  </Text>
<Option subject={[["baffles"]]}>
...
<Option subject={[["baffle valves"], ["baffle check valves"]]}>
  Prevent fuel movement to the wing tips
</Option>

  <Option>Close the vent lines in case of turbulence</Option>
  <Option>Prevent positive buildup inside the tank</Option>
  <Option>Limit high fuel flow during refuelling operations</Option>
</Question>

<Question id="8687IQRFBO" lo="021.08.02.02.01">
  <Text variant="oneCorrect">
    The operating pressure of a booster pump in a fuel supply system of a gas
    turbine aircraft is...
  </Text>

  <Option correct>20 to 100 PSI</Option>
  <Option>5 to 20 PSI</Option>
  <Option>1 to 5 PSI</Option>
  <Option>100 to 300 PSI</Option>
</Question>

<Question id="CC915FWXQO" lo="021.08.02.02.05" contentRef="#dip-sticks">
  <Text variant="oneCorrect">
    The quantity of fuel measure by a dip stick is determined using...
  </Text>
<Option correct>
  measurements from the dip stick and data tables in the aircraft documentation
</Option>
<Option why="although this is commonly done in small aircraft, it's too unreliable for large aircraft with significant temperature operational ranges">
  measurements alone
</Option>
<Option>measurements from the dipstick and the fuel's specific gravity.</Option>

  <Option>measurements from the dipstick and the current OAT.</Option>
</Question>

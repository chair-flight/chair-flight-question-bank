...
<Option id="As8yos0XWu-1" correct>
  Divergent, to reduce airflow velocity and increase static pressure in front of
  the fan.
</Option>
<Option
  id="As8yos0XWu-2"
  why="Physically, this option does not make sense as a convergent duct would result in an increased airflow and a decreased static pressure."
>
  Convergent, to reduce airflow velocity and increase static pressure in front
  of the fan.
</Option>
<Option
  id="As8yos0XWu-3"
  why="Physically, this option does not make sense as a divergent duct would result in an increased airflow and a decreased static pressure."
>
  Divergent, to increase airflow velocity and decrease static pressure in front
  of the fan.
</Option>
<Option
  id="As8yos0XWu-4"
  why="Physically this answer makes sense. However, we want to increase the static pressure in front of the engine. This &#x22;helps&#x22; the air flow into the engine as the pressure inside the engine will be lower than the pressure outside, and air flows naturally from a higher to a lower pressure."
>

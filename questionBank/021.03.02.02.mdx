...
<Question lo={["021.03.02.02.13"]} explanation="### Components">
  ...
  <Option subject={[["filters"]]} explanation="filter">
...
<Question lo={["021.03.02.02.13"]} explanations="#### Selector Valve">
  <Text variant="oneCorrect">

...
<Question id="fasA3nh" lo="021.03.02.02.07">
...
<Question id="Q1H90hQaVm" lo={["021.03.02.02.13"]} explanation="### Components">
  ...
  <Option id="Q1H90hQaVm-5" subject={["piston actuators"]}>
    To convert the hydraulic force into linear mechanical force.
  </Option>
  <Option id="Q1H90hQaVm-6" subject={["hydraulic motors"]}>
  ...
  <Option id="Q1H90hQaVm-8" subject={["non-return (check) valves"]}>
    To allow fluid to flow in one direction only.
  </Option>
  <Option id="Q1H90hQaVm-9" subject={["shuttle Valves"]}>
    To switch to the secondary system in case of leak in the primary system.
  </Option>
  <Option id="Q1H90hQaVm-A" subject={["relief valves"]}>
    To prevent excessive pressure from building up inside the system.
  </Option>
  <Option id="Q1H90hQaVm-B" subject={["restrictor valves"]}>
  ...
  <Option id="Q1H90hQaVm-D" subject={["bypass valves"]}>
  ...
  <Option id="Q1H90hQaVm-F" subject={["priority valves"]}>
    To maintain enough hydraulic pressure in critical systems in case of low
    overall system pressure.
  </Option>
  <Option id="Q1H90hQaVm-G" subject={["fuse valves", "hydraulic fuse"]}>
  ...
  <Option
    id="IDHERE-X"
    why="The closest valid definition is the accumulator, but that stores power / dampens pressure surges."
  >
    To store pressure.
  </Option>
</Question>
...
<Question
  id="kLOewcyTa8"
  lo={["021.03.02.02.13"]}
  explanations="#### Selector Valve"
>
  <Text variant="oneCorrect">
    An aircraft hydraulic selector valve which <Subject />
    when the system actuating mechanism is at idle is a....
  </Text>
  <Option id="kLOewcyTa8-1" subject={["has a low pressure fluid flow"]}>
    An open centre hydraulic selector valve
  </Option>
  <Option id="kLOewcyTa8-2" subject={["has no fluid flow"]}>
    A Closed centre hydraulic selector valve
  </Option>
  <Option id="kLOewcyTa8-3" why="There is no such a thing..">
    A positive return selector valve
  </Option>
  <Option id="kLOewcyTa8-4" why="There is no such a thing.">
    A pressure neutral hydraulic valve
  </Option>
</Question>

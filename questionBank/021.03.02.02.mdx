...
<Question id="MSA1Z4BVY2" lo="021.03.02.02.07">
  <Text variant="oneCorrect">
    What is the <Subject /> operating pressure of high-pressure hydraulic system
    in large aircraft
  </Text>

  <Option subject={[["typical"]]}>3000 psi</Option>
  <Option subject={[["maximum"]]}>4000 psi</Option>
  <Option> 2000 psi</Option>
  <Option> 1000 psi</Option>
</Question>

<Question id="HNVH63KULS" lo={["021.03.02.02.13"]} contentRef="### Components">
  <Text variant="oneCorrect">
    In a modern hydraulic system, what is the function of <Subject />?
  </Text>

  <Option subject={[["reservoirs"]]}>
    A tank in which adequate supply of fluid for the system is stored
  </Option>

  <Option subject={[["pressurized reservoirs"]]}>
    To assure the pump inlet is provided with a continuos and adequate supply of
    fluid free from foaming
  </Option>

  <Option subject={[["accumulators"]]}>

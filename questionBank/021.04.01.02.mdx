...
<Question id="MDA1Z4BVY9" lo="021.04.01.02.01">
  <Text variant="oneCorrect">
    The <Subject /> function on a landing gear shock absorber used on large
    aircraft is provided by...
  </Text>

  <Option subject={[["damping"]]}>hydraulic fluid</Option>
  <Option subject={[["spring"]]}>nitrogen</Option>
  <Option>mechanical springs</Option>
  <Option>oxygen</Option>
  <Option>water</Option>
  <Option>Halon</Option>
</Question>

<Question id="MSA1Z4BVY3" lo="021.04.01.02.01">
  <Text variant="oneCorrect">
  ...
  <Option correct>Lock the landing gear in the up or down positions</Option>
  <Option>Lock the landing gear in the down position only.</Option>
  <Option>Lock the landing gear in the up position only.</Option>
...
<Question id="ZCD1Z4BVY2" lo="021.04.01.02.05">
  <Text variant="oneCorrect">
    What state is indicated when <Subject /> on the landing gear position
    indicator
  </Text>

  <Option subject={[["All Green lights are lit"]]}>
    Landing gear in the down position and locked.
  </Option>

  <Option subject={[["All Red lights are lit"]]}>
    Lock the landing gear in a transition state
  </Option>

  <Option subject={[["No lights are lit"]]}>
    Lock the landing gear in the up position and locked.
  </Option>

  <Option>Landing gear is malfunctioning</Option>
</Question>

<Question id="MSA1Z4BVY1" lo="021.04.01.02.06">
  <Text variant="oneCorrect">
    When does the anti-retract latch blocks the landing gear operation
  </Text>

  <Option correct>With the aircraft on the ground.</Option>
  <Option>When the IAS is too low for gear retraction</Option>
  <Option>When the IAS is too high for gear retraction</Option>
...
<Question id="MSA1Z4BVD9" lo="021.04.01.02.09">
  <Text variant="oneCorrect">
    If the back-up system of extending a landing gear is of the free-fall type,
    what is moved with mechanical power?
  </Text>

  <Option correct why="In a free fall mechanism the entire landing gear movement is powered by gravity. The exception is the cut out valve that allows to release hydraulic pressure keeping the system in place, which is operated mechanically. Usually by a valve in the cockpit">
    The cut-out valve
  </Option>

  <Option why="the up lock mechanism is under hydraulic pressure. It is operated indirectly when this pressure is removed by opening the cut out valve">
    The up lock mechanism
  </Option>

  <Option>The landing gear actuators</Option>
  <Option>The selector valve</Option>
</Question>

<Question id="JU456HPUIB" lo="021.04.01.02.09">
  <Text variant="oneCorrect">
  ...
  <Option correct why="This is technically incorrect, but its the only possibly correct answer.">
    The up lock mechanism
  </Option>

  <Option why="The backup system bypasses the normal system completely. Usually the emergency process will include a step to put the landing gear leaver in the down position, but it's not the first step in the process.">
...
<Question id="0LL8DZRLQY" lo="021.04.01.02.09">
  <Text variant="oneCorrect">
    When an emergency nitrogen bottle is used for the landing gear:
  </Text>

  <Option correct why="Pneumatic emergency systems typically only perform the crucial operation of locking the gear down. All other luxuries are not performed">
    it lowers the landing gear but the doors remain open
  </Option>

  <Option>it lowers the landing gear and subsequently closes the door</Option>
  <Option>It retracts the landing gear</Option>

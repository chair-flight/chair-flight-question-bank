...
<Question lo={["021.05.04.01.02", "021.05.04.01.05"]}>
  <Text variant="oneCorrect">
    Which of the following protections is available ona fly-by-wire control
    system?
  </Text>
  <Option super alwaysCorrect>
    All of The Above
  </Option>
  <Option alwaysCorrect>Excessive g load</Option>
  <Option alwaysCorrect>Stall</Option>
  <Option alwaysCorrect>Excessive Bank Angle</Option>
  <Option alwaysCorrect>Excessive Pitch Angle</Option>
  <Option alwaysCorrect>Overspeed</Option>

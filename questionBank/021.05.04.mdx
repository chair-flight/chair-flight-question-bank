...
<Question id="8AIVWRGDXF" lo={["021.05.04.01.01"]}>
  ...
  <Option subject={[[]]}>PCUs are operated by analogue signals</Option>
  <Option subject={[[]]}>PCUs operate an hydraulic actuator</Option>
  <Option subject={[[]]}>ACEs are operated by digital signals</Option>

  <Option subject={[[]]}>
    ACEs convert digital signals into analogue signals
  </Option>

  <Option subject={[[]]}>ACEs operate the PCU using an analogue signal</Option>
  <Option subject={[[]]}>PFCs send digital signals to the ACE</Option>
  <Option>PCUs covert digital signals into analogue signals</Option>
  <Option>PCUs covert digital signals into hydraulic actuator movements</Option>
  <Option>Control wires feed pilot control movements into the PCUs</Option>
  <Option>ACEs convert analogue signals into digital signals</Option>

  <Option>
    ACEs convert digital signals into hydraulic actuator movements
  </Option>

  <Option>Flight controls are connected to control surfaces directly</Option>
</Question>

<Question id="QN0PK15VDM" lo={["021.05.04.01.02", "021.05.04.01.05"]}>
  <Text variant="oneCorrect">
    Which of the following protections is available ona fly-by-wire control
    system?
  </Text>

  <Option super correct>
    All of The Above
  </Option>

  <Option correct>Excessive g load</Option>
  <Option correct>Stall</Option>
  <Option correct>Excessive Bank Angle</Option>
  <Option correct>Excessive Pitch Angle</Option>
  <Option correct>Overspeed</Option>
  <Option>Flight into ground obstacles</Option>
  <Option>Flight into other aircraft</Option>
  <Option>Flight into restricted airspeed</Option>
</Question>
...
<Question id="A3OEFMF4X6" lo={["021.05.04.01.04"]}>
  ...
  <Option subject={[["Normal Law"], ["Normal mode"]]} why="Normal Mode is the Boeing equivalent to Airbus' Normal Law">
  ...
  <Option subject={[["Alternate Law"], ["Secondary Mode"]]} why="Secondary Mode is the Boeing equivalent to Airbus' Alternate Law">
  ...
  <Option subject={[["Direct Law"]]} why="This is an 'airbus only' mode. NOTE: this is not part of the LO's">
    In this mode all protections are lost. The flight control movements are
    directly proportional to sidestick inputs.
  </Option>

  <Option subject={[["Mechanical Backup"]]} why="This is an 'airbus only' mode. NOTE: this is not part of the LO's">

...
<Question lo="021.07.02.01.01" explanation="#pressure-differential-system">
  ...
  <Option alwaysCorrect>Small holes freeze first</Option>
  <Option alwaysCorrect>Small holes melt first</Option>
...
<Question lo="021.07.02.01.01" explanation="#smiths-ice-detector">
  <Text variant="oneCorrect">What is measured by a Smith ice detector?</Text>
  <Option>Decrease in static pressure</Option>
  <Option>Increase in static pressure</Option>
  <Option alwaysCorrect>Decrease in dynamic pressure</Option>
  <Option>Increase in dynamic pressure</Option>
</Question>

<Question lo="021.07.02.01.01">
  <Text variant="oneCorrect">
    What best describes a <Subject />?
  </Text>
  <Option subject={[["Pressure differential system"]]}>
  ...
  <Option subject={[["Smith ice detector"]]}>
  ...
  <Option subject={[["Rosemount ice detector"]]}>
  ...
  <Option subject={[["Hot rod ice detector"]]}>
...
<Question lo="021.07.02.01.02" explanation="### Ice detection systems">
  <Text variant="oneCorrect">

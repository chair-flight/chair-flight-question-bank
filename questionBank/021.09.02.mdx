...
<Question id="X70ITOG264" lo="021.09.02.01.03">
  ...
  <Option correct why="compared to Lead Acid batteries, NiCa batteries function much better at very low temperatures.">
...
<Question id="P1D9JS6GDN" lo="021.09.02.01.09">
  ...
  <Option correct why="The important thing to remember is that a fire should be handled where it happens. The laptop should not be moved around">
...
<Question id="7Y7VCNN3IY" lo="021.09.02.01.10">
  ...
  <Option correct why="If the two terminals are directly connected, the battery will quickly begin overheating">
...
<Question id="CTEQCESK2M" lo="021.09.02.01.10">
  ...
  <Option correct why="if over charging occurs, outgassing reactions occur that heat the battery leading to a thermal runaway">

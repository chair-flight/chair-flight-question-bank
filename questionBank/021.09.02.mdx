...
<Question lo="021.09.02.01.03">
  ...
  <Option alwaysCorrect>Constant output voltage</Option>
  <Option alwaysCorrect>Good storage capacity</Option>
  <Option alwaysCorrect>Sturdiness thanks to its metal casing</Option>
  <Option alwaysCorrect>
    They weight less when compared with lead-acid batteries
  </Option>
</Question>

<Question lo={["021.09.02.01.05", "021.09.02.01.06"]}>
  <Text variant="oneCorrect">
...
<Question lo="021.09.02.01.10">
  <Text variant="oneCorrect">
    What can be the cause of a significant increase in battery temperature?
  </Text>
  <Option alwaysCorrect>Thermal Runaway</Option>

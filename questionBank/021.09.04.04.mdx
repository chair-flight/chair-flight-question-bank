...
<Question id="KVNA74Fs" variant="correct" lo={["021.09.04.04.01"]} oldQuestion>
  ...
  <Option id="KVNA74Fs-3" why="">
    The GCU controls the AC generator voltage.
  </Option>
  <Option id="KVNA74Fs-4" why="">

...
1. **021.11.01.01.01** -- Describe how thrust is produced by a basic gas turbine
   engine.
2. **21.11.01.01.02** -- Describe the simple form of the thrust formula for a
...
$$
T = m ( V_{outlet} - V_{inlet}) + A (P_{inlet} - P_{outlet})
$$

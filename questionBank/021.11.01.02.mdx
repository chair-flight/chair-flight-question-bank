...
<Question
  id="CPZRcpM1AV"
  variant="correct"
  explanation="### Ideal turbine cycle"
  lo={["021.11.01.02.02"]}
>
  <Text variant="oneCorrect">
    Which of these statements about an ideal gas turbine cycle is correct
  </Text>
  <Text variant="oneTwo">
    Which of these statements about an ideal gas turbine cycle are correct
  </Text>
  <Option id="CPZRcpM1AV-1" key="1" correct>
    The process is continuos
  </Option>
  <Option id="CPZRcpM1AV-3" key="2" correct>
    Theoretically The combustion occurs at constant pressure
  </Option>
  <Option id="CPZRcpM1AV-2" key="1">
    The process is intermittent
  </Option>
  <Option id="CPZRcpM1AV-4" key="2">

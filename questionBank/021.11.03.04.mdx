...
<Question lo={["021.11.03.04.01"]} explanation="### Auxiliary gearbox">
  ...
  <Option alwaysCorrect>Starter</Option>
  <Option alwaysCorrect>Oil pump</Option>
  <Option alwaysCorrect>Tachometers</Option>
  <Option alwaysCorrect>HP Fuel Pumps</Option>
  <Option alwaysCorrect>Hydraulic Pumps</Option>
  <Option alwaysCorrect>AC generator</Option>

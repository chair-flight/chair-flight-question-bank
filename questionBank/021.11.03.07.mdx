...
<Question
  ...
  variant="correct"
  lo={["021.11.03.07.07"]}
  explanation="### Trust reverser controls and indications"
>
  ...
  <Option
    id="Shsv5TfnaK-3"
    why="This is a normal situation. The throttle lever setting corresponds to the current state of the system. No warning light required."
  >
  ...
  <Option
    id="Shsv5TfnaK-5"
    why="At full throttle the reverser doors should definitely be closed. So all is good.  No warning light required."
  >

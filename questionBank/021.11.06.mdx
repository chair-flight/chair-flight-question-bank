...
Additional to supplying electical power, APUs can also supply compressed air for
starting the main engine or for air conditioning
...
APUS must be equiped with an automatic shutdown protection system that activates
when:
...
eventually result in either overheating or not enough lubrification causing

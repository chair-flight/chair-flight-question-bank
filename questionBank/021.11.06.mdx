...
<Question lo="021.11.06.01.01">
  ...
  <Option alwaysCorrect>Air conditioning and electrical services</Option>
</Question>

<Question lo="021.11.06.01.04">
  <Text variant="oneCorrect">
  ...
  <Option alwaysCorrect>Fault status</Option>
...
<Question lo="021.11.06.01.01">
  ...
  <Option alwaysCorrect>Electricity</Option>
  <Option alwaysCorrect>Air for starting the main engine</Option>
  <Option alwaysCorrect>Air for air conditioning</Option>
  <Option alwaysCorrect>Thrust to taxi the aircraft</Option>
...
<Question lo="021.11.06.01.05">
  ...
  <Option alwaysCorrect why="Overspeed can cause fatal damage to the APU">
    Overspeed
  </Option>
  <Option
    alwaysCorrect

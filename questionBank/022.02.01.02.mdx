...
<Question  lo={["022.02.01.02.02"]}  >
  <Text  variant="oneCorrect">
    If the <Subject /> the instrument will:
  </Text>
  <Option  >gradually indicate zero</Option>
  <Option >indicate a height equivalent to the setting on the millibar subscale</Option>
  <Option  subject={[
...
<Question lo={[""]}>
  ...
  <Option alwaysCorrect>position pressure error</Option>

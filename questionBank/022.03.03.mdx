...
4.  **022.03.03.01.04** -- Describe the serviceability check for a direct-reading
...
<Question id="S62T6YB1FB" lo={["022.03.03.01.04"]}>
  ...
  <Option subject={[["264ºM"]]} why="The maximum tolerable error for a direct reading magnetic compass is 10º">
    Cancel the flight and return to maintenance
  </Option>

  <Option subject={[["262ºM"]]} why="The maximum tolerable error for a direct reading magnetic compass is 10º">

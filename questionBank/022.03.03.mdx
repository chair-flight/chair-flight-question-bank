...
<Question id="yrDfdhxbxb" variant="definition" lo={["022.03.03.01.04"]}>
  ...
  <Option
    id="yrDfdhxbxb-3"
    why="Magnetic compasses can not be directly adjustable."
  >
    Manually adjust the compass until it reads a bearing of 253ºM.
  </Option>
  <Option
    id="yrDfdhxbxb-4"
    why="If the direct reading compass is indeed INOP, you can not fly."
  >

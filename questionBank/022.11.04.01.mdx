...
5. [022.11.04.01.05] -- Describe a typical FMS pre-flight set-up process through
   the CDU/MCDU to cover the most basic information (with the aim to create
   awareness of required information as this is irrespective of aircraft type
   and FMS/FMGS make): ident page (who am I = aircraft type/variant, engine

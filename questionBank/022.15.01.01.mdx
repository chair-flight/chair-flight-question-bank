---
SyllabusReference: 022.15.01.01
Title: General, definitions and design
---
...
4. [022.15.01.01.04] -- With the help of the relevant 022 references, give
   ...
   each system, such as: ADC with pitot probe(s), static port(s) and indicators;
   FMS with GPS, CDU/MCDU and ND; GPWS with radio altimeter, ADC and ND.

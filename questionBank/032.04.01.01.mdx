...
3. **032.04.01.01.03** -- Describe the European Union airworthiness requirements
...
6. **032.04.01.01.06** -- Explain the interdependence between the above-mentioned
   speeds where relevant.
7. **032.04.01.01.07** -- Define the following distances in accordance with CS-25:
   take-off run with all engines operating and one-engine- inoperative; take-off
...
8. **032.04.01.01.08** -- Explain how loss of TORA due to alignment is accounted
   for.

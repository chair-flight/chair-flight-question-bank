...
1. **032.04.06.03.01** -- Explain the effect of runway slope, surface conditions
...
3. **032.04.06.03.03** -- Explain the effect of temperature and pressure altitude
   on the maximum landing mass for a given landing distance available.
4. **032.04.06.03.04** -- Explain the effect of hydroplaning on landing distance

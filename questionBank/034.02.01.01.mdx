...
1. **034.02.01.01.01** -- Determine the wind component, altitude and temperature
   for hovering, take-off and landing.
2. **034.02.01.01.02** -- Explain that operations are to be conducted only from/to
   heliports and over such routes, areas and diversions contained in a
   ...
   landing phases.)
3. **034.02.01.01.03** -- Explain the effect of temperature, wind and altitude on

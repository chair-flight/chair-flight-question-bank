...
3. [050.10.03.01.03] -- Describe the general meaning of MET REPORT and SPECIAL
   REPORT.
4. [050.10.03.01.04] -- List, in general, the cases when a SIGMET and an AIRMET
   are issued.
5. [050.10.03.01.05] -- Describe, decode (by using a code table) and interpret

...
<Question
  id="cejJ5UTrLQ"
  lo={["061.04.01.02.02"]}
  explanation="### Chart vs Earth convergence"
>
  <Text variant="oneCorrect">
    A <Subject /> is drawn between two points on a chart. The change in true
    track is 20º.
  </Text>
  <Option id="cejJ5UTrLQ-1" subject={["straight line"]}>
    Chart meridian convergence is 20º
  </Option>
  <Option id="cejJ5UTrLQ-2" subject={["great circle"]}>
    Earth meridian convergence is 20º
  </Option>
  <Option
    id="cejJ5UTrLQ-3"
    why="This option never makes sense. If the change in true track is 20º, the convergence is 20º."
  >

...
<Question id="xXs0JfqOdQai" variant="definition" lo={["062.01.01.03.01"]}>
  <Text variant="oneCorrect">
    <Subject /> appears in the frequency spectrum of...
  </Text>
  <Option id="xXs0JfqOdQai-1" subject={["VLF"]}>
    3-30 kHz
  </Option>
  <Option id="xXs0JfqOdQai-2" subject={["LF"]}>
    30-300 kHz
  </Option>
  <Option id="xXs0JfqOdQai-3" subject={["MF"]}>
    300-3 000 kHz
  </Option>
  <Option id="xXs0JfqOdQai-4" subject={["HF"]}>
    3-30 MHz
  </Option>
  <Option id="xXs0JfqOdQai-5" subject={["VHF"]}>
    30-300 MHz
  </Option>
  <Option id="xXs0JfqOdQai-6" subject={["UHF"]}>
    300-3 000 MHz
  </Option>
  <Option id="xXs0JfqOdQai-7" subject={["SHF"]}>
    3-30 GHz
  </Option>
  <Option id="xXs0JfqOdQai-8" subject={["EHF"]}>
    30-300 GHz
  </Option>
</Question>
...
<Question
  id="xXs0JfqOdQab"
  variant="definition"
  lo={["062.01.01.03.01", "062.02.01.01.01"]}
>
  <Text variant="oneCorrect">
    The VHF direction finder uses the following wave lengths....
  </Text>
  <Option
    id="xXs0JfqOdQab-1"
    correct
    why=" VHF range is between 30-300Mhz. When we divide the speed of light by this value we get a wave length between 0.2 and 2metres."
  >
    Metric
  </Option>
  <Option id="xXs0JfqOdQab-2">Decimetric</Option>
  <Option id="xXs0JfqOdQab-3">Centimetric</Option>
  <Option id="xXs0JfqOdQab-4">Hectometric</Option>
  <Explanation>
    {`This question is really asking you the order of magnitude of the amplitude
    for waves used in VHF (30-300 MHz) transmissions: 
    
    $$
    \frac{3\times10^{8} m/s}{(30 - 300)\times10^{6} hz} \approx (0.2 - 2)m
    $$
...
>
  ...
  <Option
    id="xXs0JOdQai-1"
    subject={["First"]}
    why="definition for first symbol"
  >
  ...
  <Option
    id="xXs0JOdQai-3"
    subject={["Second"]}
    why="definition for second symbol"
  >
  ...
  <Option
    id="xXs0JOdQai-5"
    subject={["Third"]}
    why="definition for third symbol"
  >
  ...
  <Option id="xXs0JOdQai-7" why="No such thing as a secondary carrier">
    Type of modulation of the secondary carrier
  </Option>
  <Option id="xXs0JOdQai-8" why="No such thing as a secondary carrier">

...
<Question id="aCHWlcqGkE" variant="definition" lo={["062.03.01.01.01"]}>
  ...
  <Option
    id="aCHWlcqGkE-6"
    why="Radio Altimeters use the Continuos Wave technique."
  >
    Radio altimeter
  </Option>
  <Option
    id="aCHWlcqGkE-7"
    why="A VOR ground station uses a specialized antenna system to transmit both an amplitude modulated and a frequency modulated signal."
  >
    VOR
  </Option>
  <Option id="aCHWlcqGkE-8" why="">
    Non Directional Beacons
  </Option>
</Question>

<Question id="o4qhO0WjMI" variant="definition" lo={["062.03.01.01.03"]}>
  <Text variant="oneCorrect">
  ...
  <Option
    id="o4qhO0WjMI-2"
    subject={["pulse recurrence frequency", "PRF"]}
    why=""
  >
    maximum range of radar
  </Option>
  <Option id="o4qhO0WjMI-3" why="">
    Beam width
  </Option>
  <Option id="o4qhO0WjMI-4" why="">

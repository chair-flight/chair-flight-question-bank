...
<Question id="G25C74KULS" lo={["062.03.01.01.01"]}>
  ...
  <Option subject={[["Pulse Technique"], ["Echo Principle"]]} why="RADAR ==> Pulse Technique. Use the echo principle to detect reflections off aircraft surfaces.">
    Aerodrome Surface Movement Radar
  </Option>

  <Option subject={[["Pulse Technique"], ["Echo Principle"]]} why="RADAR ==> Pulse Technique. Uses the echo principle to detect water / ice droplets">
  ...
  <Option subject={[["Pulse Technique"], ["Interrogator / transponder principle"]]} why="RADAR ==> Pulse Technique. SSR uses pulses to transmit information between the ground station and the aircraft">
    Secondary Surveillance Radar
  </Option>

  <Option subject={[["Pulse Technique"], ["Interrogator / transponder principle"]]} why="DME still uses radar, although not in its name. So it's also using the Pulse Technique. It's also using the interrogator transponder principle to obtain distance between the aircraft and the ground station.">

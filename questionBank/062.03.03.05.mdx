...
<Question id="2TEM6QSWUA" lo={["062.03.03.05.01", "062.01.02.03.02"]}>
  ...
  <Option subject={[["AWR shadowing"]]} why="Describes Radar shadowing, when an object can't be seen on radar since it's hidden behind another closer object.">
    Cloud behind another cloud can't be seen.
  </Option>

  <Option subject={[["Antenna shadowing"]]} why="Describes antenna shadowing, when the aircraft structure blocks the line of sight of the antenna.">

...
<Question id="UehBTGOAun" variant="correct" lo={["062.03.04.01.04"]}>
  ...
  <Option id="UehBTGOAun-4" correct why="">
    ATC SSR systems can interrogate aircraft transponders and elicit replies
  </Option>
  <Option
    id="UehBTGOAun-5"
    why="This is false. SSR still requires line of sight to operate"
  >
    Is not limited by line of sight
  </Option>
  <Option
    id="UehBTGOAun-6"
    why="This information is not transmitted by SSR. It can be derived from multiple SSR interrogations but it's not coded information from the surveilled aircraft."
  >
    Ground stations can obtain coded information from the surveilled aircraft
    such as speed and heading
  </Option>
  <Option id="UehBTGOAun-7" why="SSR still emits side lobes.">
  ...
  <Option
    id="UehBTGOAun-8"
    why="The flow of information is the other way around. The Ground system is the one making interrogations."
  >

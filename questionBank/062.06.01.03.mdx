...
<Question id="QJ03TX610J" lo={["062.06.01.03.01"]} explanation="## Summary">
  ...
  <Option alwaysCorrect why="Causes ionospheric propagation delay">
    Atmospheric Propagation
  </Option>
  <Option alwaysCorrect why="Describes multipath effects">

...
<Question id="PGvi8l7PHO" variant="definition" lo={["062.07.02.03.01"]}>
  <Text variant="oneCorrect">
    The "X" in "<Subject /> X" is interpreted as the ______ navigation (LNAV)
    accuracy (total system error) in _______, which is expected to be achieved
    at least ______ of the flight time by the population of aircraft operating
  ...
  <Option id="PGvi8l7PHO-3">lateral, NM, 90%</Option>
  <Option id="PGvi8l7PHO-4">lateral, NM, 85%</Option>
  <Option id="PGvi8l7PHO-5">lateral, NM, 100%</Option>
  <Option id="PGvi8l7PHO-6">lateral, km, 95%</Option>
  <Option id="PGvi8l7PHO-7">lateral, km, 90%</Option>
  <Option id="PGvi8l7PHO-8">lateral, km, 85%</Option>
  <Option id="PGvi8l7PHO-9">lateral, km, 100%</Option>
  <Option id="PGvi8l7PHO-a">longitudinal, NM, 95%</Option>
  <Option id="PGvi8l7PHO-b">longitudinal, NM, 90%</Option>
  <Option id="PGvi8l7PHO-c">longitudinal, NM, 85%</Option>
  <Option id="PGvi8l7PHO-d">longitudinal, NM, 100%</Option>
  <Option id="PGvi8l7PHO-e">longitudinal, km, 95%</Option>
  <Option id="PGvi8l7PHO-f">longitudinal, km, 90%</Option>
  <Option id="PGvi8l7PHO-g">longitudinal, km, 85%</Option>
  <Option id="PGvi8l7PHO-h">longitudinal, km, 100%</Option>
</Question>

<Question
  id="mtejuJ9Srx"
  variant="definition"
  explanation="### RNAV and RNP specifications"
  lo={[
    "062.07.02.03.03",
    "062.07.02.03.04",
    "062.07.02.03.05",
...
>
  ...
  <Option id="mtejuJ9Srx-1" subject={["RNAV 10", "RNP 4", "RNP 2"]}>
    oceanic phases of a flight.
  </Option>
  <Option id="mtejuJ9Srx-2" subject={["RNAV 10", "RNP 4", "RNP 2"]}>
    remote phases of a flight.
  </Option>
  <Option id="mtejuJ9Srx-3" subject={["RNAV 5", "RNAV 2", "RNP 2"]}>
    en-route phase phases of a flight
  </Option>
  <Option id="mtejuJ9Srx-4" subject={["RNAV 5", "RNAV 2", "RNAV 1", "RNP 1"]}>
    arrival phase phases of a flight
  </Option>
  <Option id="mtejuJ9Srx-5" subject={["RNAV 5", "RNAV 2", "RNAV 1", "RNP 1"]}>
    arrival phase phases of a flight
  </Option>
  <Option id="mtejuJ9Srx-6" subject={["RNAV 2", "RNAV 1", "RNP 1"]}>
    departure phases of a flight
  </Option>
  <Option id="mtejuJ9Srx-7" subject={["RNP 0.3"]}>
    all phases of flight except for oceanic/remote and final approach, primarily
    for helicopters
  </Option>
  <Option id="mtejuJ9Srx-8" subject={["RNAV 1", "RNP 1", "RNP 0.3"]}>
    en-route phases of low-level instrument flight rule (IFR) helicopter
    flights.
  </Option>
  <Option id="mtejuJ9Srx-9" subject={["RNAV APCH", "RNP AR APCH"]}>
    approach phase of a flight.
  </Option>
  <Option id="mtejuJ9Srx-a" why="No specification is used for all phases.">

...
1. [062.07.02.03.01] -- Interpret X in RNAV X or RNP X as the lateral navigation
   (LNAV) accuracy (total system error) in nautical miles, which is expected to
   be achieved at least 95 per cent of the flight time by the population of
   aircraft operating within the given airspace, route or procedure.
...
4. [062.07.02.03.04] -- State that RNAV 5 is used in the en-route and arrival
   phases of flight.
5. [062.07.02.03.05] -- State that RNAV 2 and RNP 2 are also used as navigation
   specifications.
...
8. [062.07.02.03.08] -- State that RNAV 1 and RNP 1 are used in the arrival and
   departure phases of flight.
9. [062.07.02.03.09] -- State that required navigation performance approach (RNP
...
10. [062.07.02.03.10] -- State that required navigation performance
    ...
    of flight.
11. [062.07.02.03.11] -- State that RNP 0.3 navigation specification is used in

...
<Question id="IKKA1J0SXJ" lo={["062.07.05.05.08", "62.07.05.05.07"]}>
  ...
  <Option correct why="GNSS provides horizontal guidance, and (baro-)VNAV vertical guidance = 3D.">
    GNSS + VNAV
  </Option>

  <Option correct why="SBAS approach procedures with vertical guidance are a 3D PBN approach.">
    SBAS
  </Option>

  <Option correct why="an RNP APCH to localiser performance with vertical guidance is a 3D PBN approach">
    RNP APCH + LPV
  </Option>

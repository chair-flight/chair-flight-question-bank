...
4. **071.01.03.04.04** -- State the planning minima for ETOPS en-route alternate.
5. **071.01.03.04.05** -- Navigation-planning procedures. Describe the operator"s
   responsibilities concerning ETOPS routes.

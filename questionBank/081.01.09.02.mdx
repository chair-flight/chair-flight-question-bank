...
1. **081.01.09.02.01** -- From the given relevant diagrams, describe or identify
...
>
  ...
  <Option id="hmrEgkXXfo-1" subject={["Krueger Flaps"]} why="">
    Leading edge devices usually located close to the wing root
  </Option>
  <Option id="hmrEgkXXfo-2" subject={["Slats"]} why="">
    Leading edge devices usually located close close to the wing tip
  </Option>
  <Option id="hmrEgkXXfo-3" subject={["Fowler Flaps"]} why="">
    Trailing edge devices usually located close to the wing root
  </Option>
  <Option id="hmrEgkXXfo-4" why="">
    Trailing edge devices located close to the wing tip only.
  </Option>
</Question>
